...
def W_z_clust(z, dz, z_i, z_f, sig_z, bias):
    """
...
def C_l_i(z_i,z_f, sig_z, bias, Omega_m_var , sig_8_var):
    """
    ...
    W_sq = (W_z_clust(zarray, dzarray, z_i, z_f, sig_z, bias)[0])**2.0
    #===================================================================================
    #===================================================================================
...
def matter_der_C_l_i(z_i, z_f, sig_z, bias, Omega_m , sig_8):
    """
    ...
    C_mat_1 = C_l_i(z_i, z_f, sig_z, bias, Omega_m+alpha_m , sig_8)[1]
    C_mat_2 = C_l_i(z_i, z_f, sig_z, bias, Omega_m-alpha_m , sig_8)[1]
...
def sigma_der_C_l_i(z_i, z_f, sig_z, bias, Omega_m , sig_8):
    """
    ...
    C_sig_1 = C_l_i(z_i, z_f, sig_z, bias, Omega_m, sig_8+alpha_s)[1]
    C_sig_2 = C_l_i(z_i, z_f, sig_z, bias, Omega_m , sig_8-alpha_s)[1]
    
    sig_der = (C_sig_1 - C_sig_2)/(2.0*alpha_s)
    return sig_der


def Fish_single_bin(z_i, z_f, sig_z, bias, f_sky, N_gal):
    """
    ...
    C_ell_1 = C_l_i(z_i, z_f, sig_z, bias, Omega_m , sigma_8)[1]
    dC_ldOm_1 = matter_der_C_l_i(z_i, z_f, sig_z, bias, Omega_m , sigma_8)
    dC_ldsig8_1 = sigma_der_C_l_i(z_i, z_f, sig_z, bias, Omega_m , sigma_8)
